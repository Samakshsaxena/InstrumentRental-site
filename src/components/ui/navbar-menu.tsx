  ...
  return (
    ...
    >
      <motion.p
        ...
        className="text-black dark:text-white hover:opacity-[0.9]"
      >
        {item}
      </motion.p>
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative flex flex-wrap justify-center items-center gap-8 md:gap-26 px-4 py-4 md:px-8 md:py-6 bg-white dark:bg-black shadow-input rounded-full border border-transparent dark:border-white/[0.2]"
    >
      {children}
    </nav>
  );
